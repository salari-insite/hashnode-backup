...
$$P: Monday\hspace{5px}comes\hspace{5px}before\hspace{5px}Tuesday$$

$$Q: Tuesday\hspace{5px}comes\hspace{5px}after\hspace{5px}Monday$$
...
$$P: I'm\hspace{5px}always\hspace{5px}right$$

$$Q: I'm\hspace{5px}sometime's\hspace{5px}wrong$$
...
$$P: Our\hspace{5px}solar\hspace{5px}system\hspace{5px}has\hspace{5px}1\hspace{5px}star$$
...
| *P* | ! *P* | *P* | ! *P* | | --- | --- | --- | | True | False | True | | False | True | True |

And voilà, we have a tautology:

$$P \lor \lnot P$$

Consider the following example statement representing the above tautology:

$$P: I'm\hspace{5px}a\hspace{5px}billionaire$$

$$\lnot P: I'm\hspace{5px}not\hspace{5px}a\hspace{5px}billionaire$$
...
| P | Q | P --&gt; Q | (P --&gt; Q) &lt;--&gt; (Q | ! P) | | --- | --- | --- | --- | | True | True | True | True | | True | False | False | True | | False | True | True | True | | False | False | True | True |

And there you have it! We formed a tautology involving 2 propositions:

$$(P \Rightarrow Q) \Leftrightarrow (Q \lor \lnot P)$$

Consider the following example propositions representing the propositions in the above tautology:

$$P: Pigs\hspace{5px}can\hspace{5px}fly$$

$$Q: Pigs\hspace{5px}are\hspace{5px}faster\hspace{5px}than\hspace{5px}airplanes$$

As an English statement, our tautology is "Pigs are faster than airplanes or pigs can't fly if, and only if, if pigs can fly, then pigs are faster than airplanes". Regardless of whether those propositions are true or false on their own, that statement is always logically true.
...
Back to our contradiction, let's now add in a disjunction between the first statement and the first proposition.
...
If you notice, the truth values of our statement are logically equivalent to the first proposition.
...
We can then form the contradiction "Either I live on Earth and I'm not a human, or I live on Earth. Also, I don't live on Earth". Regardless of whether these propositions are true, this statement will always be logically false.
