...
I hope that after reading this article, you now feel comfortable with some of the basic operations and functions that you can apply to various data types in Python.

You learned about all the basics of booleans, integers, floats, complex numbers, strings, lists, tuples, sets, and dictionaries in Python.

If you have any lingering questions that you'd like me to answer, please ask away in the comments below.

Additionally, if you have any suggestions for an article topic you'd like me to cover in the future, feel free to also drop those in the comments below.
